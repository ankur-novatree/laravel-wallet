...
<form action="{{ URL::to('transaction-type') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
    <div class="form-group">
        <label class="col-md-3 control-label" for="example-text-input">Transaction Type Name</label>
        <div class="col-md-6">
            <input type="text" id="example-text-input" name="code" class="form-control" placeholder="Transaction Type Name">
        </div>
    </div>
